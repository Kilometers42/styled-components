...
var BaseStyledNativeComponent = function (_Component) {
  ...
  function BaseStyledNativeComponent() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.attrs = {}, _this.onRef = function (node) {
  ...
  BaseStyledNativeComponent.prototype.render = function render() {
    ...
    return React__default.createElement(
      ...
      function (theme) {
        ...
        var propsForElement = _extends({}, _this2.attrs, _this2.props, {
        ...
        target.prototype && 'isReactComponent' in target.prototype)) {
          propsForElement.ref = _this2.onRef;
          delete propsForElement.innerRef;
        } else {
          propsForElement.innerRef = _this2.onRef;
        }
...
var _StyledNativeComponent = (function (InlineStyle) {
  var createStyledNativeComponent = function createStyledNativeComponent(target, options, rules) {
    ...
    var inlineStyle = new InlineStyle(rules);
